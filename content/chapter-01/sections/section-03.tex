...
\begin{lesson}
    ...
    \textbf{Ví dụ 1.} Tìm hai số tự nhiên có tổng bằng $1006$, biết rằng nếu lấy số lớn chia cho số nhỏ thì được thương là $2$ và số dư là $124$.
    ...
    Tổng hai số bằng $1006$ nên ta có phương trình
    \[
        x+y=1006. \tag{1}
    \]
    ...
    \[
        \dfrac{1}{x}=\dfrac{3}{2}\cdot\dfrac{1}{y},
    \]
    hay
    \[
        \dfrac{1}{x}-\dfrac{3}{2y}=0. \tag{3}
    \]
    ...
    \[
        \dfrac{1}{x}+\dfrac{1}{y}=\dfrac{1}{24}. \tag{4}
    \]
    ...
    Giải hệ (II): Thế $u=\dfrac{3}{2}v$ vào phương trình (4), ta được $\dfrac{3}{2}v+v=\dfrac{1}{24}$, suy ra $v=\dfrac{1}{60}$. Do đó $u=\dfrac{1}{40}$.

    Từ đó, ta có:
    \[
        \dfrac{1}{x}=\dfrac{1}{40}\ \text{suy ra }x=40;
        \qquad
        \dfrac{1}{y}=\dfrac{1}{60}\ \text{suy ra }y=60.
    \]
