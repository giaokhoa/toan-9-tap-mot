...
\begin{practice}
    ...
    \begin{questions}[resume=SBT]
        ...
        trong đó $p$ là giá mỗi đơn vị (tính bằng đô la) và $x$ là số lượng đơn vị sản phẩm. Tìm \textit{điểm cân bằng} của thị trường này, tức là điểm $(p;x)$ thoả mãn cả hai phương trình cung và cầu.
