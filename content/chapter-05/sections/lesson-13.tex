...
\begin{lesson}
    ...
    \begin{center}
        \begin{tikzpicture}
            ...
            \coordinate (L) at ($(A)!0.5!(O)$);
            \coordinate (R) at ($(O)!0.5!(B)$);
            \draw (O) circle (1.8);
            \draw (A)--(B);
            \fill (O) circle (1.2pt);
            \fill (A) circle (1.2pt);
            ...
            \draw ($(L)+(0,-0.08)$)--($(L)+(0,0.08)$);
            \draw ($(R)+(0,-0.08)$)--($(R)+(0,0.08)$);
        \end{tikzpicture}
    ...
    \begin{center}
        \begin{tikzpicture}
            ...
            \coordinate (A) at (-1.8,0);
            \coordinate (B) at (1.8,0);
            \coordinate (M) at (48:1.8);
            \coordinate (N) at ($(M)!2!(O)$);
            \coordinate (H) at ($(A)!(M)!(B)$);
            \coordinate (P) at ($(M)!2!(H)$);
            \draw (O) circle (1.8);
            \draw (A)--(B);
            \draw (N)--(M);
            \draw (M)--(P);
