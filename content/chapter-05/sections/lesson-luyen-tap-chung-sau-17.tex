...
\begin{exercises}
    ...
    \begin{center}
        \begin{tikzpicture}
            ...
            \draw (O) circle[radius={sqrt(1.2^2+1.35^2)}cm];
            \draw (Op) circle[radius={sqrt(1.6^2+1.35^2)}cm];
    ...
    \begin{enumerate}[label=\alph*)]
        ...
        Tam giác $ABM$ có $BO$ là đường trung tuyến và $BO=\dfrac{1}{2}AM$ (bán kính bằng nửa đường kính) nên là tam giác vuông tại $B$. Vậy $\angle MBA=90^\circ$.

        Tương tự, ta cũng có $N\in (O')$ và $\angle ABN=90^\circ$. Từ hai kết quả trên suy ra
        \[
            \angle MBN=\angle MBA+\angle ABN=90^\circ+90^\circ=180^\circ.
        \]
