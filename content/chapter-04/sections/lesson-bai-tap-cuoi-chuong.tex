...
\begin{exercises}
    ...
    \begin{questions}[resume=SGK]
        ...
        \begin{tikzpicture}
            ...
            \node[left=2pt of $(A)!0.5!(C)$] {$3$};
            \node[right=2pt of $(C)!0.5!(B)$] {$4$};
            \node[below=2pt of $(A)!0.5!(B)$] {$5$};
        ...
        \begin{tikzpicture}
            ...
            \node[below=8pt of $(M)!0.5!(P)$] {Hình 4.33};
        \end{tikzpicture}
        \end{center}
        ...
        \begin{tikzpicture}
            ...
            \node[below=8pt of $(B)!0.5!(A)$] {Hình 4.34};
        \end{tikzpicture}
        \end{center}
    ...
    \begin{questions}[resume=SGK]
        ...
        \begin{tikzpicture}
            ...
            \node[below=2pt of $(L)!0.5!(R)+(0,-0.25)$] {$4{,}4\ \text{m}$};
            \node[right=2pt of $(T)!0.5!(H)$] {$1{,}8\ \text{m}$};
        ...
        \begin{tikzpicture}
            ...
            \node[below=2pt of $(T)!0.5!(R)$] {$5\ \text{m}$};
        ...
        \begin{tikzpicture}
            ...
            \node[below right=1pt of A] {$A$};
            \node[above right=1pt of C] {$C$};
            \node[below=8pt of $(B)!0.5!(A)$] {Hình 4.37};
        \end{tikzpicture}
        \end{center}
        ...
        \begin{enumerate}[label=\arabic*.]
            ...
            \item Cũng vào trưa một ngày Hạ chí, ở thành phố Alexandria (A-lếch-xăng-đri-a) cách Syene 800 km, Eratosthenes thấy một tháp cao 25 m có bóng trên mặt đất dài 3,1 m.
        \end{enumerate}
        ...
        % TODO(HINH-NGUON): bo sung asset/crop Hinh 4.38 tu SGK trang 82; khong redraw xap xi bang TikZ.
        \answerline
        \answerline
        \answerline
        \answerline
...
\begin{practice}
    ...
    \begin{questions}[resume=SBT]
        ...
        \begin{tikzpicture}
            ...
            \coordinate (E) at (6.4,4.2);
            \path (A) -- ++(-15:6.4) coordinate (Dline);
            \coordinate (D) at (6.4,{4.2-6.4*tan(15)});
            \draw (B)--(A);
            \draw (C)--(D);
            \draw (B)--(C);
            \draw[dashed] (A)--(E);
            ...
            \node[below=2pt of $(B)!0.5!(C)$] {$32\ \text{m}$};
            \node[below=9pt of $(B)!0.5!(C)$] {Hình 4.16};
        \end{tikzpicture}
        \end{center}
        ...
        % TODO(HINH-NGUON): bo sung asset/crop Hinh 4.18 tu SBT trang 52; khong redraw xap xi bang TikZ.
        \answerline
        \answerline
        \answerline
        ...
        \begin{tikzpicture}
            ...
            \node[left=1pt of B] {$B$};
            \node[left=1pt of A] {$A$};
            \node[below=8pt of $(I)!0.5!(K)$] {Hình 4.20};
        \end{tikzpicture}
        \end{center}
        ...
        % TODO(HINH-NGUON): bo sung asset/crop Hinh 4.21 tu SBT trang 53; khong redraw xap xi bang TikZ.
        \answerline
        \answerline
        \answerline
