...
\begin{lesson}
    ...
    \begin{tikzpicture}
        ...
        \pic[draw, "$45^\circ$", angle radius=5mm, angle eccentricity=1.35] {angle=A--C--B};
        \node[above] at (A) {$A$};
        \node[below left] at (B) {$B$};
        \node[below right] at (C) {$C$};
    ...
    \begin{tikzpicture}
        ...
        \pic[draw, "$60^\circ$", angle radius=5mm, angle eccentricity=1.35] {angle=C--B--A};
    ...
    \begin{tikzpicture}
        ...
        \pic[draw, "$\alpha$", angle radius=6mm, angle eccentricity=1.35] {angle=B--A--C};
        \pic[draw, "$\beta$", angle radius=6mm, angle eccentricity=1.35] {angle=C--B--A};
        \node[below left] at (A) {$A$};
...
\input{content/chapter-04/sections/section-11-exercises}
\input{content/chapter-04/sections/section-11-practice}
