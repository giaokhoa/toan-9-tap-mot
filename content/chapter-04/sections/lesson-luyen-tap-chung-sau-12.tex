...
\begin{lesson}
    ...
    \begin{center}
        \begin{tikzpicture}
            ...
            \pic[draw, angle radius=5mm] {angle=D--I--C};
            \node[above left=1pt of B] {$B$};
    ...
    \begin{questions}[resume=SGK]
        ...
        \begin{center}
            \begin{tikzpicture}
                ...
                \pic[draw, angle radius=4mm] {angle=D2--B2--A2};
                ...
                \pic[draw, angle radius=4mm] {angle=C3--A3--B3};
                ...
                \coordinate (B4) at ($(A4)!0.6!(C4)$);
                \coordinate (H4) at (B4 |- A4);
                \coordinate (K4) at (C4 |- A4);
                \draw (A4)--(C4);
                \draw (A4)--(K4);
                \draw (B4)--(H4);
                \draw (C4)--(K4);
        ...
        \begin{center}
            \begin{tikzpicture}
                ...
                \node[above=2pt of $(C)!0.5!(A)$] {$90\text{ m}$};
