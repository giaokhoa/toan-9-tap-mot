...
\begin{exercises}
    ...
    \begin{questions}[resume=SGK]
        ...
        \item Biết rằng nhiệt lượng toả ra trên dây dẫn được tính bởi công thức $Q=I^2Rt$, trong đó $Q$ là nhiệt lượng tính bằng đơn vị Joule (J), $R$ là điện trở tính bằng đơn vị Ohm ($\Omega$), $I$ là cường độ dòng điện tính bằng đơn vị Ampe (A), $t$ là thời gian tính bằng giây (s). Dòng điện chạy qua một dây dẫn có $R=10\,\Omega$ trong thời gian $5$ giây.
        \begin{questions}
            ...
            \item Cường độ dòng điện là bao nhiêu Ampe để nhiệt lượng toả ra trên dây dẫn đạt $800$ J?
        \end{questions}
        \answerline
        \answerline
    \end{questions}
