...
\begin{lesson}
    ...
    \textbf{Ví dụ 1.} Viết nhân tử số của biểu thức dưới dấu căn thành tích các luỹ thừa rồi đưa thừa số ra ngoài dấu căn:
...
\begin{practice}
    ...
    \begin{questions}[resume=SBT]
        ...
        \item
        \begin{questions}
            \item Trục căn thức ở mẫu của biểu thức
            \[
